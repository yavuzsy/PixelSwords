...
public class ShakeUp : StateMachineBehaviour
{
    ...
    override public void OnStateUpdate(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        if (Time.timeScale != 0)
        {
            ...
            float maxYOffset = 0.5f; // Kameranın maksimum yükseklik değişimi
            yOffset = Mathf.Clamp(yOffset, -maxYOffset, maxYOffset); // Yükseklik değişimini sınırla
